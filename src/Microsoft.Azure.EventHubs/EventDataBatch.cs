...
namespace Microsoft.Azure.EventHubs
{
    ...
    /// <summary>A helper class for creating an IEnumerable<EventData> taking into account the max size limit of the IEnumerable<EventData>, so that it can be passed to the Send or SendAsync method of an EventHubClient to send the EventData objects as batch.</summary>
